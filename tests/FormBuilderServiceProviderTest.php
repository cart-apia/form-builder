...
namespace {
    ...
    class FormBuilderServiceProviderTest extends FormBuilderTestCase
    {
        ...
        protected function resolveApplicationConfiguration($app)
        {
            ...
            $app['config']->set('form-builder.form_builder_class', MyFormBuilder::class);
        }
        ...
        public function it_dependency_injects()
        {
            ...
            $this->assertInstanceOf(MyFormBuilder::class, $this->app['form-builder']);

            // Dependency injected MyFormBuilder in SomeService is from the container.
            $service = $this->app->build(SomeService::class);
            $this->assertIdentical($service->fb, $this->app['form-builder']);
            ...
            $this->assertIdentical($fb2, $this->app['form-builder']);
        }
